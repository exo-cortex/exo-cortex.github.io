...
date = 2021-05-30
draft = false
slug = "advanced-visualization-studio"

[taxonomies]
tags = ["avs", "visuals", "art"]
...
{% row() %}
{{ videoloop(src="/video/trip.webm") }}
{{ videoloop(src="/video/try_one.webm") }}
{{ videoloop(src="/video/disco.webm") }}
{% end %}
...
[^2]: see my post about [reaction diffusion systems](/blog/reaction-diffusion/)
